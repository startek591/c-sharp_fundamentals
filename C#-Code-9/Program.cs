namespace ConsoleApp9
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Lambda expression allow you to 
            // use anonyomous methods that define
            // that input parameters on the left
            // and the code to execute on the right

            // Assign a Lambda to the delegate
            doubleIt dblIt = x => x * 2;
            Console.WriteLine($"% * 2 = {dblIt(5)}");
            ...
            Console.WriteLine("Any > 3 : {0}", numList5.Any(x => x > 3));
            ...
            // Intersect
            // Recieves 2 lists and returns values that
            // both lists have
