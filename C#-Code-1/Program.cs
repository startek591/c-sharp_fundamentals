...
namespace HelloWorld
{
    ...
    public class Program
    {
        ...
        static double DoDivision(double x, double y)
        {
            if (y == 0)
            {
                // We are throwing an exeception because
        ...
        // to its values in the method effect it outside
        // of the method
        ...
        OtherSchool:
            ...
            while (i <= 10)
            {
                ...
                if (i % 2 == 0)
                {
                    ...
                    // Continue skip the rest of the code and 
            ...
            // finally always runs provides for clean up
            finally
            {
