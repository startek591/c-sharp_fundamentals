...
namespace HelloWorld
{
    public class Program
    {
        ...
        private static void SayHello()
        {
            ...
            // Sve the input the user provides
        ...
        static void Main(string[] args)
        {
            ...
            // Define decimals
            Console.WriteLine("# Decimals : {0:f3}", 23.4555);
            ...
            // Create an arrray of base objects which is the 
            ...
            // column worth of data on each page
            ...
            // Create an array with Create Instance
            Array anotherArray = Array.CreateInstance(typeof(int), 10);

            // Copy vaues in srcArray to destArray starting
        ...
        OtherSchool:
            ...
            while (i <= 10)
            {
                ...
                if (i % 2 == 0)
                {
                    ...
                    // starts execution back a the top of the
                    // while
                    continue;
                }
            ...
            do
            {
                ...
                // Use Convert to swtich the string into an int
            ...
            // systems
            // <Access Specific> <Return Type> <Method Name>(Parameters)
            // { <Body> }
            ...
            // method using params. You also pass
            // in a array.
            ...
            // name thart will be called depending on
