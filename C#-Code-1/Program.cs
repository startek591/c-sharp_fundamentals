...
namespace HelloWorld
{
    public class Program
    {
        ...
        // to its value in the method effect its outside
        // of the method
        ...
        OtherSchool:
            ...
            // whe you are working with large blocks of text
            // StringBuilders actually change the text
            // rather then make a copy

            // Create a StringBuilder with a defualt size
            ...
            // protected : Can't be accessed by class and dervied classes
