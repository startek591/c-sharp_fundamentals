...
namespace ConsoleApp11
{
    ...
    // You mainpulate data using Query Expressions
    class Program
    {
        ...
        static void QueryCollection()
        {
            ...
            var animaListEnum = animalList.OfType<Animal>();

            var bigDogs = from dog in animaListEnum
        ...
        static void QueryAnimalData()
        {
            ...
            // equals values for IDs
            // Store values fro animal and owner
            var innerJoin =
